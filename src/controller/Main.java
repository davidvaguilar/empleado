	...
	public static void main(String[] args) {
		...
		switch (String.valueOf(seleccion).charAt(0)) {
			...
			case '2':
				...
				break;
			case '3':
				id=JOptionPane.showInputDialog("Ingrese Id Persona a Eliminar");
				int idInt=Integer.parseInt(id);
				personita1.setPerId(idInt);
				boolean resultado=perDao.eliminar(personita1);
				if(resultado) {
					JOptionPane.showMessageDialog(null, "Persona id:"+personita1.getPerId()+" Eliminada exitosamente");
				}else {
